...
<template>
  <section class="w-full flex flex-col items-center p-4 gap-4">
    ...
    <h2 class="text-2xl">Twoje dane kontaktowe</h2>
    <div
      class="w-full max-w-[72rem] flex flex-col md:flex-row justify-center gap-8 overflow-y-auto"
    >
      <div
        class="relative w-full md:w-1/2 max-w-[36rem] flex flex-col gap-2 p-4 bg-[#D9D9D9] rounded-lg"
      >
    ...
    <div
      class="relative w-full max-w-[42rem] flex flex-col gap-2 p-4 text-center md:text-start bg-[#D9D9D9] rounded-lg"
    >
